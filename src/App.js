...
const App = () => {
  ...
  const questionAnswers = [
    ...
    questions: [
      ...
      answer: "9",
      type: "number"},
      {question: "What Denver landmark is depicted on the 2020 Xero t-shirt?",
      answer: "Blue Mustang",
      type: "text"},
    ...
    {category: "English",
    questions: [
      {question: "How many passives are there in this sentence: ‘Dates can be entered in any format, but how they’re extracted and displayed on the document is determined by the region set’?",
      answer: "4",
      type: "number"},
    ...
    {category: "Technology",
    questions: [
      {question: "What nifty feature in Adobe Audition helps you remove mouth clicks in VO?",
      answer: "Heal",
      type: "text"},
