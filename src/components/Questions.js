...
const Questions = ({ questions, pageNum, setPageNum, retries, setRetries }) => {
  ...
  return (
    <div className="w-1/2">
      <QuestionCard
        currentAnswer={currentAnswer0}
        setCurrentAnswer={setCurrentAnswer0}
        correct={correct0}
        setCorrect={setCorrect0}
        question={questions[0]}
        index={0}
      />
      <QuestionCard
        currentAnswer={currentAnswer1}
        setCurrentAnswer={setCurrentAnswer1}
        correct={correct1}
        setCorrect={setCorrect1}
        question={questions[1]}
        index={1}
      />
      <QuestionCard
        currentAnswer={currentAnswer2}
        setCurrentAnswer={setCurrentAnswer2}
        correct={correct2}
      ...
      {!(correct0 && correct1 && correct2) ? (
        <div className="w-full flex justify-center mt-4">
          <button
            className="w-full bg-green-500 active:bg-green-700 text-white py-1 px-2 rounded focus:outline-none"
      ...
      {correct0 && correct1 && correct2 ? (
        <button
          className="w-full flex justify-end items-center mt-2 focus:outline-none"
          onClick={handleNext}
        >
